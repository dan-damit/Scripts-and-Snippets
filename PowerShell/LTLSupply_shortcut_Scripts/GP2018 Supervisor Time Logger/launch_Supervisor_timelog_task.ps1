...
[CmdletBinding()]
param(
    [string]$TaskName   = 'Launch_GP_TimeLog',
    [string]$Runner     = "C:\ProgramData\TechToolbox\GP2018 Supervisor Time Logger\launch_super_timelog.ps1",
...
if ($CreateDesktopShortcut) {
    $shortcutPath = "$env:PUBLIC\Desktop\GP2018 Supervisor Time Logger.lnk"
    ...
    $sc.IconLocation = "C:\Program Files (x86)\Microsoft Dynamics\GP2018\Super\Dynamics.exe,0"
