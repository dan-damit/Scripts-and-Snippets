...
# Prompts for information if no search is found in the case
...
function Update-ResolveOrCreateSearch {
    ...
    # Try to find the original search
    try {
...
try {
    ...
    $cloneName = Update-ResolveOrCreateSearch -CaseName $caseName -OriginalSearchName $searchName
