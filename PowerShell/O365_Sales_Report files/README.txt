...
- The Authentication Certificate (including the private key) installed in 'Cert:\LocalMachine\My' Store 
  to run as SYSTEM in PDQ or from whatever server/workstation we select to run the script.
